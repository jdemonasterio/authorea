...
The first of two fits was ran over a smaller hyperparameter configuration.

In particular, this configuration did not consider a rebalancing of the samples when computing the loss function over the whole set.


idea was
 and plotted their output in a graph which shows up to five levels of splits.
