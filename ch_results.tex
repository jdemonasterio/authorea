...
% Problem 4: Users that migrated from the endemic region, but conditional to users which are currently not endemic i.e. the base of users which
...
% Still this result does not imply that all split all users
 % It seems that a big area as a result of their mobile phone usage and as such, this attribute might indicative of past migrations.
...
\begin{itemize}
    ...
    Both mobility diamater attributes were highlighted, where in one considered the mobility of users during weekdays and for the other, only specific mobility during weeknights.
