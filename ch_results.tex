...
At the same time we had that the biggest differences between the average training and CV errors, across hyperparameter values, was at most of $10\%$.
...
As expected,
we saw how this model overfit the
