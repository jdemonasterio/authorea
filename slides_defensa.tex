...
\begin{frame}{ Ajust Poly-M vs Ajuste Poly-2 }
\center
...
Algoritmo recursivo y aleatorio que particiona el espacio en forma binaria:
	...
	\begin{block}{Idea}
		...
		A partir de una funcion de impureza $Imp$
		\begin{align*}
	...
	\begin{block}{Función de perdida}
		...
		\end{align*}
 	con $K$ el numero de regiones de la particion final
	\end{block}
\end{frame}
...
\begin{frame}{Comparacion de Fronteras de Decision}
		\includegraphics[width = 0.9 \paperwidth, height = 0.7 \paperheight, 
...
Optimizacion de configuraciones de hiperparametros $\mathcal{A}$ via estimacion del $EPE$
	...
	\begin{block}{Idea}
		...
		\\
		donde cada clasificador $\hat{f}^{-k}$ aprende sin usar las muestras de la particion $k$
		\\
...
\begin{frame}{Definición de problemas de migracion A}
...
\begin{frame}{Definición de problemas de migracion B}
