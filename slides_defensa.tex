...
\begin{frame}{Objetivo}
	...
	\begin{itemize}
		...
		%explicar vertical, congenita y transfusion/transplante
		\item \ldots utilizar datos de telefonia celular
		% for which a low proportion of the infected population knows that they have the disease.
...
\begin{frame}{Error de Prediccion Esperado}
		\centering
...
\begin{frame}{Registros de Llamados Celulares (CDRs)}
	...
	$\approx$ 10 mil millones de registros detallados de llamados (CDRs) para Mexico y Argentina con 24 y 5 meses de datos respectivamente.
...
%	\bigskip
	...
	\begin{block}{Region de residencia}
	Un usuario es asignado a una region a partir de $H_u$
\end{block}
