...
\begin{frame}{Árbol de ejemplo}
		\includegraphics[width = 0.9 \paperwidth, height = 0.7 \paperheight,
										trim = 0.2 80 0.2 0.2cm, left, clip = true]{decisión_tree/full_tree_map.png}
\end{frame}
...
\begin{frame}{Conclusiones Inesperadas}
	...
	\medskip
	Los tres tipos de atributos más relevantes para la clasificaición de los migrantes estaban relaciónadas con:
