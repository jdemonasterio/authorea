...
where $c_k$ is the value that our model estimates for samples in the $A_k$ region. Both of these will have to be estimated by the model by minimizing its loss function.
...
In the binary (two class) case, if we consider $p$ to be the probability of success, these measures can be expressed as
