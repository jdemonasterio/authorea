Primero, dar una introduccion a Machine Learning, que es, que hace, notacion, como se usa y algunos aspectos mas de "cambio de paradigma" o "filosofia" o como quieran llamarlo. Comentar algo del foco en training error, predictive power, generalizaciones,etc
