...
Having a class of functions that has a finite VC dimension conceptually means it is not that \textit{rich}. More complex class of functions can better shatter a set of points.
