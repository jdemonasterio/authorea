...
$$mg(\textbf{x},\textbf{y}) =  P_Theta(h(\textbf{x}) = \textbf{y})  
- max_{j\neq \textbf{y}}\left(P_Theta(h_k(\textbf{x}) = j) \right) $$ \label{eq:rf-marginFunRf}

and the strength will be defined as 

$$s =  \Expect_{\textbf{x},\textbf{y}}\left mg(\textbf{x},\textbf{y}) \right) $$ \label{eq:rf-strength}
