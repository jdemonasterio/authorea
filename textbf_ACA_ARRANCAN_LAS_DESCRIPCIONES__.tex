...
With this definitions, it is straight to see that 

\begin{equation}%\end{equation}
mr(\textbf{x},\textbf{y})ˆ2 = \Expect_{\Theta, \Theta'}\left[ rmg(\Theta,\textbf{x},\textbf{y} ) rmg(\Theta',\textbf{x},\textbf{y} )   \right]. 
\end{equation}
