...
\section{Supervised Classification Learning vs. Unsupervised and then Classification vs. Regression}
...
"A computer program is said to learn from experience E with respect to some class of tasks T and performance measure P if its performance at tasks in T, as measured by P, improves with experience E" . To our purpose it is clear though that this definition is not formally well-defined. However it serves to convey the idea of algorithms that automatically become better over time and with more data. Note that the "goodness" of their performance is inherently subjected to the evaluation criteria chosen for the task. Because of this,\textit{learning} is less associated with a cognitive definition in this context and more to a performance based approach.

Examples of these machine learning programs are now widespread to the point where their use has direct impact on the lives of millions of people. A non-exhausitve list of applicaitons include self-driving cars, spam detection systems, face-voice recognition , AI opponents in games, etc.  

Machine learning is a subfield of Computer Science with broad intersections with statistics and mathematical optimization.
 It is divided into two main categories: Supervised and Unsupervised. The difference is simple, where in the fist case algorithms  are set to produce outputs, noted by $Y$, from input data, noted by $X$. The standard naming convention  
