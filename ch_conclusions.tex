...
\begin{description}
    ...
    Some examples of other algorithms not shown in this workd are K-Nearest Neighbors, Support Vector Machines and Classification Neural Networks.   
    ...
    In a future iteration, it would be interesting to revaluate the results with the opinion of other domain experts where the algorithm's performance could be seen differently.
