...
\begin{table}[ht]
    ...
    \caption{A representation of the top features that resulted from the Random Forest experiment on target4. }\label{tab:random_forest_big_experiment_best_features}
\end{table}


The top features list shows us the importance of mobility diameter in both cases.
Where for weeknights and for the whole week, the user's mobility is  relevant to detect his past endemic condition. The same happens with the amount of
the prediction of the target. other time periods this the vulnerability condition in
