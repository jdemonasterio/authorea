...
%  \centering
  ...
  \end{minipage}
\caption{ Side comparison of validation curves for two hyperparameters of the Random Forest learner. The mean CV scores for the $1 - F1$ score is shown for \cref{target1} where the number and the depth of the trees of each model were our varied hyperparameters.}
...
%  \centering
  ...
  \end{minipage}
\caption{ Side comparison of validation curves for two hyperparameters of the Gradient Boosting learner. The mean CV scores for the $1 - F1$ score is shown for \cref{target1}, where, again, the number and depth of the trees hyperparameters were tested in separate experiments.}
