...
To build an estimate of the generalization error on the ensemble classifier, these individual scores and the relationship between them must measured.
...
\todo{add figures of the validation curve comparing max depth of the tree vs the score (in a CV procedure) and the number of trees vs the results of using decision trees}
