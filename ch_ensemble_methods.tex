...
The top features list shows us the importance of mobility diameter for both cases, where we found that the user mobility is relevant to detect a past endemic condition, both for mobility specific to weeknights and, also, for mobility during the whole week.
