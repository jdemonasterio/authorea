...
This booster was first introduced by Friedman, J., and the full details of the work can be found in Full details of this model can be found in \textcite{friedman-gradientBoosting2001}.
...
For the third experiment, we traing \textbf{only} with the best features extracted from the Random Forest's second experiment.
...
Using the same setup as before, we recorded the outcome of the three experiments's cross validation procedures.
