...
\todo{add experiment for this classifier. Talk about how fast it is to set it up, with few hyperparameters and almost no prior knowledge. Talk about fast execution and runs as well.}
