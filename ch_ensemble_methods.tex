...
The Boosting models were built to classify on task \cref{target1} and the $F1$ score was used to evalute their performance.
...
This accelaration is clear from the figure where the CV score is invariant while the training error decreases.
...
The outcomes here expose the drawbacks of this model which is more prone to overfitting and takes longer to fit when comapred to the Random Forest algorithm.
