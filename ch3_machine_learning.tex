...
\begin{equation}
 ...
 \end{equation}
 \label{logit-logOddss} for $i,j \in \{1,2,...,K\}, i\neq j$
...
\begin{equation}
p(C_k| x) = \frac{P(x|C_k)P(C_k)}{P(x)}
\end{equation}\label{equation-posteriorProbabilties}
...
\end{equation}\label{equation-posteriorProbabilityDecomposition1}
