...
Each were optimized separately in order to exmplify how the overall $ROC AUC$ varied along different regularization thresholds.
...
In\cref{ch:ensembleMethods} we introduce four new classifiers along with their properties and characteristics.

% For each, we presented an introductory review and pointed the reader to further readings where needed.
