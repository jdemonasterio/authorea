...
\todo{This chapter is work in progress.}
...
\section{Random notes to add to results}
...
\begin{description}
    ...
    \item Suprising low F1 overall when best-fitting on ROC AUC.\ Models seem to overvalue recall with a huge loss in precision. This would be interesting to weight under the eyes of a health researcher. Where focus might be either on one over the other. \todo{ask Diego Weinberg}.
