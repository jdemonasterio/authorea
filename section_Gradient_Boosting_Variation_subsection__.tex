...
\]
with $\theta_j \in \mathbb{R} \ \forall j = 1,...,J$ and $ \coprod_{j=1}^J R_j$ is a partition of features space. Here $q : X \mapsto {1,...,J}$ is the function that maps samples to regions. 
