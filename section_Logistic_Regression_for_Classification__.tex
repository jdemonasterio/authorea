...
If we take into account that $P(y=1 \mid x,\theta) = 1 - P(y=0 \mid x,\theta)$ , then the estimation of $\theta$ for $N$ samples gives
...
\[
P(Y =y \mid W)  = \product_{i=1}^N P(C_1 \mid x_i)^y_i(1 - P(C_1 \mid x_i) )^(1-y_i)
\]
