...
\todo{reemplazar esta figure con los resultados de nuestra corrida con un Decision Tree, haciendo referencia a la tecnica que se introduce en el futuro.}
...
\todo{do this with own data if possible? (can't overfit with logReg yet. Which is the only technique introduced up to this point.)}
...
\todo{show with/without CV and different results with logreg for some of the problems}
