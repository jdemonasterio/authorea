...
% and the expecatation is take  with respect to the joint distribution Pr(Y,X).
...
Both of these formulas will be thoroughly used throughout this work, and it is with the generalization errar that we will estimte the $EPE$.
