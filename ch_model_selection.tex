...
To do this, we set up to find users that lived in endemic regions in the past, namely \cref{target1}, yet excluding certain features which are correlated with the target variable: the current user\'s endemicity and the state in which this user is living.
