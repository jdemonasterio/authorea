...
\hat{f}
Historically the errors due to bias and variance where associated directly to the squared loss function. This function is defined as $L(z,w) = \left\Vert z-w \right\Vert^2_2$ and it was favored over other functions because of its analytical advantages.  
