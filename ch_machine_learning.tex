...
$$C = \frac{1}{\lambda}$$
and built models for different values of $C$. Each resulting model's error was measured for the $\mathrm{T}$ and $\mathrm{Ts}$ sets seprately and graphed in \cref{fig:log_loss_regularization_validation_curve}. As we can see from this graph, there is a clear tendency to have
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\columnwidth]{figures/regularization/figure-roc_auc_error_validation_curve.png}
