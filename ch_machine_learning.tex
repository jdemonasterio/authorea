...
Otherwise we would have a perfect correlation between $Y_u=0$ and beign currently endemic, or living in an endemic state.
...
Throughout \cref{ch:modelSelection,ch:ensembleMethods,ch:results,ch:conclusion} we will come back to these problems by applying them with the techniques and methods we discuss.
