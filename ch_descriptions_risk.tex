...
\begin{table}[ht]
	\caption{Example of features extraed from the social graph data.}\label{tab:data_example}
	\centering
...
\begin{table}[ht]
	\caption{Matrix of endemicity change combinging endemicity and time factors.}\label{tab:changes}
	\centering
	\begin{tabular}{l r r }
		\toprule
