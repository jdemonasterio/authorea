...
\begin{table}[ht]
	\caption{Ane example list of features that were built from the social graph dataset. Each attribute has it\'s code name and a description of the codes used to construct its name.}\label{tab:data_example}
	\footnotesize
	\centering
