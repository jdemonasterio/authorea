...
\newcommand*{\titlepg}{%
  \begingroup
  \begin{figure}[!htbp]
  	\includegraphics[scale=0.5]{figures/uba_logo/250px-UBA.png}
  \end{figure}
...
% 	\bigskip\Large{Explorando migraciones chagásicas en latinoamérica con aprendizaje automático}}\\
 	\bigskip\Large{Explorando migraciones y difusión del mal de Chagas en América Latina con aprendizaje automático}}\\
      ...
      \textbf{\huge{Director }}
      \vfill
      \textsc{\huge{Carlos Sarraute}}
      \vfill
      \textbf{\huge{Co-director }}
      \vfill
      \textsc{\huge{Alejo Salles}}
      \vfill
      \textbf{\huge{Jurados}}
      \vfill
      \textsc{\huge{Matthieu Jonckheere, Pablo Groisman}}
      \vfill
      \textbf{\Large{Diciembre 22, 2017}}
    \end{center}
  \endgroup
