...
\newcommand*{\titlepg}{%
  \begingroup
    ...
    \begin{center}
      ...
      \vspace{\baselineskip}
      {\bfseries\Huge{Exploring Latin-American Chagas with Big Data}\par
      \bigskip\Large{A Machine Learning approach }}\\
      \vspace{\baselineskip}
      \rule{\textwidth}{1.5pt}\par
      \vfill
